...
As agents like Codex take on larger portions of the software lifecycle, these questions will matter even more. We hope that sharing some early lessons helps you reason about where to invest your effort so [<u class="decoration-1 underline-offset-4"><span>you can just build things</span></u>](https://openai.com/codex/).
