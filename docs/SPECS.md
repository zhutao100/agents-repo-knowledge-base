...
```json
{
  "symbol_id": "sym:v3:0123456789abcdef",
  "lang": "rust",
  "path": "src/lib.rs",
  "kind": "function",
  "name": "parse_thing",
...
* `sym:v3:<HEX_SHA256_64>`

Where `<HEX_SHA256_64>` is the first 64 bits (16 lowercase hex chars) of the SHA-256 of the **canonical symbol key**.
